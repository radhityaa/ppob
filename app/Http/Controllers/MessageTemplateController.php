...
class MessageTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<a href="' . route('message-template.edit', $row->id) . '" class="btn btn-warning btn-sm">Edit</a>';
        ...
        return view('message-template.index', compact('title'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('message-template.edit', compact('title', 'data'));
    }
