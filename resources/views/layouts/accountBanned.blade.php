...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-1 mx-2">Akun Anda Telah di Banned!</h2>
            <p class="mb-4 mx-2">Akun anda di banned oleh admin, silahkan hubungi admin untuk informasi lebih lanjut</p>
